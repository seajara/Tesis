...
class Solicitud extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_solicitud, id_compania, id_comuna, rut, nombre, ap_paterno, ap_materno, patrocinador, rut_pat, estado', 'required'),
			array('id_solicitud, id_compania, estado', 'numerical', 'integerOnly'=>true),
