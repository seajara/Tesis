 ...
 */
class Solicitudrecibidas extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_compania, id_comuna, rut, nombre, ap_paterno, ap_materno, patrocinador, rut_pat, estado', 'required'),
			...
			array('id_solicitud, id_compania, id_comuna, rut, nombre, ap_paterno, ap_materno, fecha_nac, estado_civil, profesion, direccion, trabajo, calidad, patrocinador, rut_pat, estado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'rut0' => array(self::BELONGS_TO, 'CuentaPostulante', 'rut'),
		);
	}
	...
	{
		return array(
			'id_solicitud' => 'Código Solicitud',
			'id_compania' => 'Código Compania',
			'id_comuna' => 'Comuna',
			'rut' => 'Rut',
			'nombre' => 'Nombre',
